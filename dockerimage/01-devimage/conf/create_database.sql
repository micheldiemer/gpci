...
--
-- Client :  127.0.0.1
-- Gérée :  Lun 18 Avril 2016 à6:13
-- Version du serveur :  5.6.25-log
-- Version de PHP :  5.6.11


--
-- Current Database: `gpci`
--

CREATE DATABASE /*!32312 IF NOT EXISTS*/ `gpci` /*!40100 DEFAULT CHARACTER SET latin1 */;

USE `gpci`;


CREATE USER 'gpciweb'@'localhost' IDENTIFIED BY 'VGD1SGX3KR0G7PRJ';
CREATE USER 'wwwgpci'@'localhost' IDENTIFIED BY 'MTZXwZ5fpNEuxBBp';
...
GRANT SELECT, INSERT, UPDATE, DELETE, CREATE, INDEX, DROP, ALTER, CREATE TEMPORARY TABLES, LOCK TABLES ON gpci.*  TO 'wwwgpci'@'localhost';
...
(1, 'admin', '79dab24f39387b54b8bf23eaae0f929eeb1ebe82', 'Admin', 'ADMIN', 'admin@localhost', 1, 1, '236155714eb110f2ff5.50325128', 'test', NULL, '');
...
--
-- AUTO_INCREMENT pour les tables exporté
--
