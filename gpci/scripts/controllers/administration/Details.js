  ...
  function (
    ...
    function listeners() {
      $scope.$watch(
        ...
        function () {
          if (
            $scope.personne.firstName != undefined &&
            $scope.personne.lastName != undefined
          )
            changeLogin();
        },
        true
    ...
    function changeLogin() {
      $scope.personne.login =
        $scope.personne.firstName.substring(0, 1).toLowerCase() +
        $scope.personne.lastName.toLowerCase();
    }
