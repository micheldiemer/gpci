webApp.factory(
  ...
  function (uiCalendarConfig, indispoService, BASE_URL) {
    ...
    const dayClick = function (date, jsEvent, view) {
      const i = indispoService.checkDayForIndispo(date);
      if (i !== 4) {
    ...
    const eventSources = [eventsGoogle, events];
