      ...
      var dayRender = function (date, cell) {
         if (
            ...
            switch (indispoService.checkDayForIndispo(date)) {
               case 1:
                  cell.append(
                     '<p class="day-text"><strong>Journée</strong></p>'
                  );
               ...
               case 3:
                  cell.append(
                     '<p class="day-text"><strong>Après-midi</strong></p>'
                  );
                  cell.css("background-color", "#FF851B");
                  break;
               case 4:
                  cell.append(
                     '<p class="day-text"><strong>Période</strong></p>'
                  );
                  cell.css("background-color", "#AAAAAA");
                  break;
               case 0:
                  cell.append(
                     '<p class="day-text"><strong>Disponible</strong></p>'
                  );
            ...
            return {
               ...
               enseignant:
                  rawEventData.user != undefined
                     ? rawEventData.user.firstName +
                       " " +
                       rawEventData.user.lastName
                     : "",
      ...
      var eventRender = function (event, element, view) {
         if (view.type == "agendaWeek")
            if (element.hasClass("coursEvent")) {
               element
                  .find(".fc-content")
                  .append("<p>" + event.enseignant + "</p>");
               element
                  .find(".fc-content")
                  .append("<p>" + event.classes + "</p>");
            }
      };
