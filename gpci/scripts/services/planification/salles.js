    ...
    function($q, notifService, Restangular) {
        ...
        function updateList() {
            return $q(function(resolve, reject) {
                ...
                Restangular.all("plan/salle").getList().then(function(data) {
                    list = [].concat(data);
        ...
        function getOne(id) {
            return $q(function(resolve, reject) {
                //TO DO Lancer toastr chargement
                Restangular.one("plan/salle", id).get().then(function(data) {
                    //TO DO SUCCESS TOASTR
                    resolve(data);
                }, function() {
                    //TO DO ERROR TOASTR
